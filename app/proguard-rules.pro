...
#1.实体类 等
#-keep class com.hytc.pupilplay.entity.** { *; }
#-keep class com.hytc.pupilplay.bean.** { *; }
#-keep class com.hytc.pupilplay.weight.** { *; }
#-keep class com.hytc.pupilplay.contact.** { *; }
