...
import static com.nnmedia.page.model.local.ReadSettingManager.SHARED_READ_CONVERT_TYPE;
...
public class StringUtils {
    ...
    public static String getString(@StringRes int id) {
        return FrApp.getInstance().getResources().getString(id);
    }

    public static String getString(@StringRes int id, Object... formatArgs) {
        return FrApp.getInstance().getResources().getString(id, formatArgs);
    }
