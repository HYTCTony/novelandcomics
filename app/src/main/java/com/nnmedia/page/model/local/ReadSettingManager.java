...
import com.nnmedia.page.utils.SharedPreUtils;
...
public class ReadSettingManager {
    ...
    public static final String SHARED_AUTOMATIC_UNLOCKING = "shared_automatic_unlocking";
    ...
    public void setAutomaticUnlocking(boolean AU) {
        sharedPreUtils.putBoolean(SHARED_AUTOMATIC_UNLOCKING, AU);
    }

    public boolean getAutomaticUnlocking() {
        return sharedPreUtils.getBoolean(SHARED_AUTOMATIC_UNLOCKING, false);
    }
}