...
public class BookChapterDao extends AbstractDao<BookChapter, String> {
    ...
    public static class Properties {
        ...
        public final static Property Is_canview = new Property(10, int.class, "is_canview", false, "IS_CANVIEW");
        public final static Property Hpoint = new Property(11, int.class, "hpoint", false, "HPOINT");
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"BOOK_CHAPTER\" (" + //
                ...
                "\"IS_CANVIEW\" INTEGER NOT NULL ," + // 10: is_canview
                "\"HPOINT\" INTEGER NOT NULL ," + // 11: hpoint
    ...
    protected final void bindValues(DatabaseStatement stmt, BookChapter entity) {
        ...
        stmt.bindLong(11, entity.getIs_canview());
        stmt.bindLong(12, entity.getHpoint());
    ...
    public BookChapter readEntity(Cursor cursor, int offset) {
        BookChapter entity = new BookChapter( //
            ...
            cursor.getInt(offset + 10), // is_canview
            cursor.getInt(offset + 11), // hpoint
    ...
    public void readEntity(Cursor cursor, BookChapter entity, int offset) {
        ...
        entity.setIs_canview(cursor.getInt(offset + 10));
        entity.setHpoint(cursor.getInt(offset + 11));
