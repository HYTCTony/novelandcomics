...
public class BookShelfListBean implements Serializable {
    ...
    public String getNovel_name() {
        ...
        if (TextUtils.isEmpty(ss)) {
            ...
            return StringUtils.convertCC(ss, FrApp.getInstance());
        }
    }
    ...
    public List<String> getTag() {
        ...
        for (String t : tag) {
            String ss = AESCBCUtil.decrypt2(t, AESCBCUtil.getKey(), AESCBCUtil.getIv());
            list.add(ss);
        }
    ...
    public String getCopyright_name() {
        String ss = AESCBCUtil.decrypt2(copyright_name, AESCBCUtil.getKey(), AESCBCUtil.getIv());
        if (TextUtils.isEmpty(ss)) {
    ...
    public String getIntroduce() {
        ...
        if (TextUtils.isEmpty(ss)) {
            return StringUtils.convertCC(introduce, FrApp.getInstance());
        } else {
            return StringUtils.convertCC(ss, FrApp.getInstance());
        }
    }
