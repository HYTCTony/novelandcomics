package com.nnmedia.comics.ui.adapter;
...
import com.nnmedia.comics.fresco.processor.MangaPostprocessor;
import com.nnmedia.comics.model.ImageUrl;
import com.nnmedia.comics.ui.widget.OnTapGestureListener;
import com.nnmedia.comics.ui.widget.PhotoDraweeView;
...
public class ReaderAdapter extends BaseAdapter<ImageUrl> {
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, int position) {
        ...
        for (int i = 0; i != urls.length; ++i) {
            ...
            if (!isCloseAutoResizeImage) {
                ResizeOptions options = isVertical ? new ResizeOptions(FrApp.mWidthPixels, FrApp.mHeightPixels) :
                        new ResizeOptions(FrApp.mHeightPixels, FrApp.mWidthPixels);
    ...
    private boolean isNeedResize(ImageUrl imageUrl) {
        // 长图例如条漫不 resize
        return (imageUrl.getWidth() * 2) > imageUrl.getHeight() && imageUrl.getSize() > FrApp.mLargePixels;
    }
