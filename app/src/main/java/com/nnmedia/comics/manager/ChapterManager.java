...
import  com.nnmedia.page.model.dao.ChapterDao.Properties;
...
public class ChapterManager {
    ...
    private static  com.nnmedia.comics.manager.ChapterManager mInstance;
    ...
    public static  com.nnmedia.comics.manager.ChapterManager getInstance(AppGetter getter) {
        if (mInstance == null) {
            synchronized ( com.nnmedia.comics.manager.ChapterManager.class) {
                if (mInstance == null) {
                    mInstance = new  com.nnmedia.comics.manager.ChapterManager(getter);
                }
            }
        }
        return mInstance;
