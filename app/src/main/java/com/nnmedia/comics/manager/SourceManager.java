...
import  com.nnmedia.page.model.dao.SourceDao.Properties;
import  com.nnmedia.comics.parser.Parser;
import  com.nnmedia.comics.source.*;
...
public class SourceManager {
    ...
    private static  com.nnmedia.comics.manager.SourceManager mInstance;
    ...
    public static  com.nnmedia.comics.manager.SourceManager getInstance(AppGetter getter) {
        if (mInstance == null) {
            synchronized ( com.nnmedia.comics.manager.SourceManager.class) {
                if (mInstance == null) {
                    mInstance = new  com.nnmedia.comics.manager.SourceManager(getter);
                }
            }
        }
        return mInstance;
