...
import com.nnmedia.page.model.dao.ComicDao.Properties;
...
public class ComicManager {
    ...
    private static com.nnmedia.comics.manager.ComicManager mInstance;
    ...
    public static  com.nnmedia.comics.manager.ComicManager getInstance(AppGetter getter) {
        if (mInstance == null) {
            synchronized ( com.nnmedia.comics.manager.ComicManager.class) {
                if (mInstance == null) {
                    mInstance = new  com.nnmedia.comics.manager.ComicManager(getter);
                }
            }
        }
        return mInstance;
