...
class TreeDocumentFile extends DocumentFile {
    ...
    private void list() {
        ...
        try {
            ...
            while (c.moveToNext()) {
                ...
                mSubFiles.put(displayName, new  com.nnmedia.comics.saf.TreeDocumentFile(this, mContext, documentUri, displayName, c.getString(2)));
            }
        } finally {
            closeQuietly(c);
        }
    ...
    public DocumentFile createFile(String displayName) {
        ...
        try {
            ...
            if (result != null) {
                doc = new  com.nnmedia.comics.saf.TreeDocumentFile(this, mContext, result, displayName, null);
    ...
    public DocumentFile createDirectory(String displayName) {
        ...
        try {
            ...
            if (result != null) {
                doc = new  com.nnmedia.comics.saf.TreeDocumentFile(this, mContext, result, displayName, DocumentsContract.Document.MIME_TYPE_DIR);
                mSubFiles.put(displayName, doc);
            }
        } catch (FileNotFoundException e) {
        }
    ...
    public boolean delete() {
        try {
            if (DocumentsContract.deleteDocument(mContext.getContentResolver(), mUri)) {
                // 为求方便，就这样吧
                (( com.nnmedia.comics.saf.TreeDocumentFile) getParentFile()).mSubFiles.remove(mDisplayName);
                return true;
            }
        } catch (FileNotFoundException e) {
        }
