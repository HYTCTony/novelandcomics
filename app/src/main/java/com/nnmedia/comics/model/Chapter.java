...
public class Chapter implements Parcelable {
    ...
    public final static Creator< com.nnmedia.comics.model.Chapter> CREATOR = new Creator< com.nnmedia.comics.model.Chapter>() {
        @Override
        public  com.nnmedia.comics.model.Chapter createFromParcel(Parcel source) {
            return new  com.nnmedia.comics.model.Chapter(source);
        }

        @Override
        public  com.nnmedia.comics.model.Chapter[] newArray(int size) {
            return new  com.nnmedia.comics.model.Chapter[size];
        }
    };
    ...
    public boolean equals(Object o) {
        return o instanceof  com.nnmedia.comics.model.Chapter && (( com.nnmedia.comics.model.Chapter) o).path.equals(path);
    }
