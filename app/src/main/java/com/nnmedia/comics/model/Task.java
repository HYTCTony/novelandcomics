...
public class Task implements Parcelable {
    ...
    public final static Creator<com.nnmedia.comics.model.Task> CREATOR = new Creator<com.nnmedia.comics.model.Task>() {
        @Override
        public com.nnmedia.comics.model.Task createFromParcel(Parcel source) {
            return new com.nnmedia.comics.model.Task(source);
        }

        @Override
        public com.nnmedia.comics.model.Task[] newArray(int size) {
            return new com.nnmedia.comics.model.Task[size];
        }
    };
    ...
    public boolean equals(Object o) {
        return o instanceof com.nnmedia.comics.model.Task && ((com.nnmedia.comics.model.Task) o).id.equals(id);
    }
