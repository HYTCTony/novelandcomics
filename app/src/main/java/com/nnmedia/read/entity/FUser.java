...
public class FUser implements Serializable {
    ...
    private int is_getfree;                 //是否获取过新人VIP（1是，2否）

    //游客
    public FUser() {
    }

    public FUser(String id, String username, int gender, String distribution, String mobile, int super_vip, boolean is_vip, long vip_end, boolean is_tourist,
                 String http_avatar, boolean is_invited, boolean is_new, boolean is_wx, int like, int is_getfree) {
        this.id = id;
    ...
    public int getIs_getfree() {
        return is_getfree;
    }

    public void setIs_getfree(int is_getfree) {
        this.is_getfree = is_getfree;
    }
