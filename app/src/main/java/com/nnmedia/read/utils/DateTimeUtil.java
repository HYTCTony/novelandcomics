...
public class DateTimeUtil {
     ...
     * @return
     */
    public static int getAgeByBirth(String strDate) {
        Date date = parseDate(strDate, DF_YYYY_MM_DD);
        if (date == null) {
            return 0;
        }
    ...
    public static String getFormateDate() {
        ...
        String systemTime =
                (month < 10 ? "0" + month : month) + "/" + (day < 10 ? "0" + day : day) + "  " + (hour < 10 ? "0" + hour : hour) + ":" + (minute < 10 ?
    ...
    /**
     * 将2017-07-10 00:00:00 换2017-07
     *
     * @param strDate
     * @return
     */
    public static String strFormatStrYYYYMM(String strDate) {
        if (strDate.equals("")) {
            return "";
        }
        return dateToStrYYYYMM(strToDate(strDate));
    }
    ...
    public static Long stringToLong(String param) throws ParseException {
        SimpleDateFormat format = new SimpleDateFormat(DF_YYYY_MM_DD_HH_MM_SS);
        return format.parse(param).getTime();
    }
    ...
    public static long getTimeInterval(String date) {
        ...
        try {
            ...
            interval = beginTime.getTime() - currentTime.getTime();// 时间差
        } catch (ParseException e) {
            e.printStackTrace();
        }
        return interval;
