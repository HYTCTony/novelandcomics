...
public interface Func {
     ...
     * 头：token---token
     */
    String USER_CHECKTOKEN = "/user/checktoken";
    /**
     * 用途：设置性别---来书籍推荐
     * 头：token---token
     * 参数：
     ...
     * identifier( Y）--- 手机唯一标志符
     */
    String USER_PASSWORD_LOGIN = "/login/password";
    /**
     * 用途：修改密码（POST）
     * 参数：
     * mobile (Y）--- 手机号
     ...
     * identifier( Y）--- 手机唯一标志符
     */
    String USER_CHANGE_PASSWORD = "/user/changepassword";
    /**
     * 用途：注册账号（POST）
     * 参数：
     * mobile (Y）--- 手机号
     ...
     * identifier( Y）--- 手机唯一标志符
     */
    String USER_REGISTER = "/register/mobile";
    /**
     * 用途：微信登录（POST）
     * 参数：
     * username   (Y）--- 昵称
     ...
     * 参数：
     */
    String SHARE_INDEX = "/share/index";
     ...
     * 头：token---token(Y)
     */
    String UNLOCK_CHAPTER = "/novel/unlock_chapter";
     ...
     * 参数：
     */
    String POINT_EARNINGS_LIST = "/point/index";
    /**
     * 用途：阅读点收支明细（GET）
     * 头：token---token(Y)
     * 参数：
     */
    String H_POINT_EARNINGS_LIST = "/hpoint/index";
    /**
     * 用途：绑定银行卡（POST）
     * 头：token---token(Y)
     * 参数：
     ...
     * 参数：
     */
    String GET_FREE_VIP = "/user/getfreevip";
    /**
     * 用途：充值列表（GET）
     * 头：token---token(Y)
     * 参数：
     ...
     * 参数：
     */
    String ORDER_EXCHANGE = "/orderexchange/setmeal";
    /**
     * 用途：cdkey兑换
     * 头：token---token(Y)
     * 参数：(string)卡密：voucher
     */
    String CDKEY_EXCHANGE = "/cdkey/exchange";
    /**
     * 用途：卡密兑换明细
     * 头：token---token(Y)
     * 参数：
     */
    String CDKEY_RECORD = "/cdkey/record";
    /**
     * 用途：获取卡密平台查询页链接
     * 头：token---token(Y)
     * 参数：
     */
    String CDKEY_ORDER_RECORD = "/cdkey/orderquery ";
    /**
     * 用途：套餐列表（GET）
     * 头：token---token(Y)
     * 参数：
     */
    String ORDER_ESCROW = "/orderescrow/setmeal";
    /**
     * 用途：阅读点充值列表（GET）
     * 头：token---token(Y)
     * 参数：
     */
    String ORDER_EXCHANGE_FOR_H_POINT = "/orderescrow/hpointlist";
    /**
     * 用途：充值明细（GET）
     * 头：token---token(Y)
     * 参数：
     */
    String ORDER_ESCROW_RECORD = "/orderescrow/record";
    /**
     * 用途：金币套餐列表（GET）
     * 头：token---token(Y)
     * 参数：
     */
    String ORDER_EXCHANGE_FOR_GOLD = "/orderexchange/goldsetmeal";
    /**
     * 用途：推广点套餐列表（GET）
     * 头：token---token(Y)
     * 参数：
     */
    String ORDER_EXCHANGE_FOR_POINT = "/orderexchange/pointsetmeal";
     ...
     * id --- 套餐ID
     */
    String ORDER_EXCHANGE_CREATE = "/orderexchange/create";
    /**
     * 用途：创建第三方支付订单（POST）
     * 头：token---token(Y)
     * 参数：
     * id --- 套餐ID
     */
    String ORDER_ESCROW_CREATE = "/orderescrow/create";
    /**
     * 用途：微信支付（POST）
     * 头：token---token(Y)
     * 参数：
     ...
     * return 查询充值情况
     */
    String PAY_QUERY = "/orderescrow/query";
    /**
     * 用途：代付接口1（微信）
     * 头：token---token(Y)
     * 参数：
     * order_id --- 套餐ID
     */
    String PAY_ESCROW_WX_1 = "/pay/escrow_wx";
    /**
     * 用途：代付接口1（支付宝）
     * 头：token---token(Y)
     * 参数：
     * order_id --- 套餐ID
     */
    String PAY_ESCROW_ALI_1 = "/pay/escrow_ali";
    /**
     * 用途：代付接口1（测试）
     * 头：token---token(Y)
     * 参数：
     * order_id --- 套餐ID
     */
    String PAY_ESCROW_TEST = "/pay/escrow_test";
    /**
     * 用途：卡密订单标记
     * 头：token---token(Y)
     * 参数：
     * (string)order_sn：订单号
     */
    String PAY_ESCROW_CDKET = "/orderescrow/mark";
    /**
     * 用途：检查更新
     * 参数：
     */
     ...
     * 参数：
     */
    String AD_TAIL = "/advertisement/tail";
    /**
     * 用途：横幅广告
     * 头：token---token(Y)
     * 参数：
     */
    String AD_BANNER = "/advertisement/banner";
    /**
     * 用途：横幅广告（个人中心）
     * 头：token---token(Y)
     * 参数：
     */
    String AD_BANNER_USER = "/advertisement/usercenter";
    /**
     * 用途：插屏广告
     * 头：token---token(Y)
     * 参数：
     */
    String AD_PLAQUE = "/advertisement/plaque";
}
