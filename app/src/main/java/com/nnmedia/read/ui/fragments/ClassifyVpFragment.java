...
import com.nnmedia.read.ui.adapters.ClassifyBookListAdapter;
...
//        tvHitsCenter.setText(FigureProcessor.formatGreet(mActivity, book.getGreet()));
        String hits = book.getScore() + getString(R.string.unit_score);
        tvHitsCenter.setText(hits);
    }
