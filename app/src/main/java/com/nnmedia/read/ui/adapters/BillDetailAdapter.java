...
public class BillDetailAdapter extends BaseQuickAdapter<BillDetailEntity, BaseViewHolder> implements LoadMoreModule {
    ...
    @Override
    protected void convert(@NonNull BaseViewHolder holder, BillDetailEntity data) {
        String orderStatu;
