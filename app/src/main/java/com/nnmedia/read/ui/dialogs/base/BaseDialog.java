package com.nnmedia.read.ui.dialogs.base;
...
public abstract class BaseDialog extends DialogFragment {
    ...
    private boolean mCancel = true;//点击返回键取消
...
//        setStyle(STYLE_NORMAL, android.R.style.Theme_Black_NoTitleBar_Fullscreen);  全屏

        setStyle(DialogFragment.STYLE_NO_TITLE, R.style.DuobaoNormalDialog);
...
//        setCancelable(mOutCancel);
        this.getDialog().setCanceledOnTouchOutside(mOutCancel);
        this.getDialog().setCancelable(mCancel);
    }
     ...
     * @return
     */
    public BaseDialog setBackCancel(boolean backCancel) {
        mCancel = backCancel;
        return this;
    }
