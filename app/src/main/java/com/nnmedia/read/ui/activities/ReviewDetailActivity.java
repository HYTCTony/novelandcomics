...
import com.nnmedia.page.utils.KeyBoardUtils;
...
import com.nnmedia.read.ui.adapters.BookReviewReplyAdapter;
...
//                                recyclerView.smoothScrollToPosition(mAdapter.getItemCount());
    ...
    private void reqPostReply(String novelId, String content, String reviewId) {
        content = AESCBCUtil.encrypt2(content, AESCBCUtil.getKey(), AESCBCUtil.getIv());
