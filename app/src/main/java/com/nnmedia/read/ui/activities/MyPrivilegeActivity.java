...
import com.nnmedia.read.ebsevent.WXPaySuccessEvent;
import com.nnmedia.read.entity.FUser;
import com.nnmedia.read.entity.PaymentInfoEntity;
import com.nnmedia.read.entity.ReChargeSetEntity;
import com.nnmedia.read.listeners.OnClickEvent;
import com.nnmedia.read.payment.PayResult;
import com.nnmedia.read.rxhttp.OnError;
import com.nnmedia.read.ui.adapters.VipComboAdapter;
...
//        initWarmPrompt();
    ...
    @Override
    public void onVipComboSelect(String comboId, String alipay, String weixin, double discountPrice) {
...
//        Log.e("sssss", "ssss===" + fUser.getSuper_vip());
    ...
    private PaymentSelectDialog.PConvertListener viewConvertListener = (holder, data, dialog) -> {
        ...
        holder.setOnClickListener(R.id.rtl_asBtn_payment_pay_1, view -> {
            cb1.setChecked(true);
            cb2.setChecked(false);
        });
        holder.setOnClickListener(R.id.rtl_asBtn_payment_pay_2, view -> {
        ...
        btnConfirm.setOnClickListener(new OnClickEvent() {
            @Override
            public void singleClick(View v) {
                Tos.showShort(MyPrivilegeActivity.this, "支付通道暂时关闭，开放时间另行通知");
    ...
    private void reqSubmitOrder(String comboId) {
        RxHttp.postForm(Consts.ORDER_CREATE_API)
                ...
                .subscribe(data -> PaymentSelectDialog.newInstance(data)
                        ...
                        .show(getSupportFragmentManager()), (OnError) error -> TipDialog.show(MyPrivilegeActivity.this, error.getErrorMsg(),
