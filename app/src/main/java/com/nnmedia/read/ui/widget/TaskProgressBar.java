...
public class TaskProgressBar extends View {
    ...
    public TaskProgressBar(Context context, AttributeSet attrs,
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.TaskProgressBar);
        try {
            mMax = a.getInt(R.styleable.TaskProgressBar_cpb_max, DEFAULT_MAX);
            mProgress = a.getInt(R.styleable.TaskProgressBar_cpb_progress, DEFAULT_PROGRESS);
            mRadius = (int) a.getDimension(R.styleable.TaskProgressBar_cpb_progressRadius, DEFAULT_RADIUS);
            mProgressColor = a.getColor(R.styleable.TaskProgressBar_cpb_progressColor, DEFAULT_PROGRESS_COLOR);
            mProgressDescColor = a.getColor(R.styleable.TaskProgressBar_cpb_progressDescColor, DEFAULT_PROGRESS_DESC_COLOR);
            mBorderWidth = (int) a.getDimension(R.styleable.TaskProgressBar_cpb_borderWidth, DEFAULT_BORDER_WIDTH);
            mProgressDesc = a.getString(R.styleable.TaskProgressBar_cpb_progressDesc);
            mIsShowDesc = a.getBoolean(R.styleable.TaskProgressBar_cpb_isShowDesc, DEFAULT_ISSHOWDESC);
