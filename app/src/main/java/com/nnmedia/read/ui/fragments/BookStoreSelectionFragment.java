...
import com.nnmedia.read.entity.EditorRecoEntity;
import com.nnmedia.read.entity.HomePageEntity;
import com.nnmedia.read.entity.RvTitleEntity;
import com.nnmedia.read.entity.multi.HpBGModuleEntity;
import com.nnmedia.read.entity.sections.HpSection;
import com.nnmedia.read.rxhttp.OnError;
import com.nnmedia.read.ui.activities.BookDetailsActivity;
import com.nnmedia.read.ui.adapters.BsSelectionAdapter;
...
//        mAdapter.setHeaderWithEmptyEnable(true);
    ...
    public void setListener() {
        ...
        mRefreshLayout.setOnRefreshListener(refreshLayout -> {
            reqIndexDatas(false, CacheMode.REQUEST_NETWORK_FAILED_READ_CACHE);
            //可以上拉加载
        ...
        mAdapter.getLoadMoreModule().setOnLoadMoreListener(() -> {
            reqHighMarksDatas(curPage, CacheMode.REQUEST_NETWORK_FAILED_READ_CACHE);
        });
    }
...
//            reqIndexDatas(false);
    ...
    private List<HpSection> constructDatas4Rv(HomePageEntity hpDatas) {
        ...
        for (int i = 0; i < modules.size(); i++) {
            ...
            datas.add(new HpSection(true, new RvTitleEntity(moduleEntity.getId(), moduleEntity.getName(), moduleEntity.getIntroduce(),
                    moduleEntity.getLabel())));
     ...
     */
    private void reqIndexDatas(boolean showDialog, CacheMode cacheMode) {
     ...
     * @param prePage 上一页页码
     */
    private void reqHighMarksDatas(int prePage, CacheMode cacheMode) {
