...
public class HPointAdapter extends BaseQuickAdapter<GoldExpenditureBean, BaseViewHolder> implements LoadMoreModule {

    public HPointAdapter() {
    ...
    protected void convert(@NonNull BaseViewHolder holder, GoldExpenditureBean data) {
        ...
        if (goldCoinCount >= 0) {
            ...
            holder.setText(R.id.tv_gold_coin_count_gc_dt, String.format(getContext().getString(R.string.txt_add_h_point_x), goldCoinCount));
        } else {
            holder.setTextColor(R.id.tv_gold_coin_count_gc_dt, ContextCompat.getColor(getContext(), R.color.green));
            holder.setText(R.id.tv_gold_coin_count_gc_dt, String.format(getContext().getString(R.string.txt_add_h_point_x), goldCoinCount));
            holder.setText(R.id.tv_gold_coin_count_gc_dt, String.format(getContext().getString(R.string.txt_del_h_point_x), Math.abs(goldCoinCount)));
        }
    }
}
