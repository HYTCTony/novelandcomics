...
//                onVipComboSelectListenr.onVipComboSelect(data.getId(), data.getAlipay(), data.getWeixin(), data.getDiscount_price());
            }
...
//                        onVipComboSelectListenr.onVipComboSelect(data.getId(), data.getAlipay(), data.getWeixin(), data.getDiscount_price());
    ...
    public interface OnVipComboSelectListenr {
        void onVipComboSelect(String comboId, String alipay, String weixin, double discountPrice);
    }
}
