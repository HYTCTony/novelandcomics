...
import com.nnmedia.read.ui.fragments.RankingBoyGirlFragment;
...
public class RankPagerAdapter extends FragmentPagerAdapter {
    ...
    public RankPagerAdapter(FragmentManager fm, String[] titles) {
    ...
    public Fragment getItem(int i) {
        if (i == 0) {
            return RankingBoyGirlFragment.newInstance(Consts.TYPE_BOY, i);
        } else {
            return RankingBoyGirlFragment.newInstance(Consts.TYPE_GIRL, i);
        }
    }
