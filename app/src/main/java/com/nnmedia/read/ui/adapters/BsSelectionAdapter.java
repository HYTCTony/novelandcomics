        ...
        if (object instanceof BookEntity) {
            ...
            switch (holder.getItemViewType()) {
                ...
                case HpSection.SE_TYPE_HOT_SEARCH://实时热搜类型的
                    GlideUtil.loadRoundRect(getContext(), holder.getView(R.id.iv_book_cover), novel.getHttp_image());
                    holder.setText(R.id.tv_book_name, novel.getName());
                    holder.setText(R.id.tv_search_count, String.format(getContext().getString(R.string.txt_search_count_x),
                            FigureProcessor.formatNum(getContext(), novel.getNumber())));
                    break;
                ...
                case HpSection.SE_TYPE_LIST://List类型的
                    ...
                    holder.setText(R.id.tv_book_author_pen_name_and_book_kind, novel.getCategory());
//                    List<String> tags = novel.getTag();
//                    if (tags != null && tags.size() > 0) {
//                        holder.setText(R.id.tv_book_author_pen_name_and_book_kind, novel.getAuthor() + "·" + tags.get(0));
//                    } else {
