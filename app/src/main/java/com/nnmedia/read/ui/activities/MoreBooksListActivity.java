...
import com.nnmedia.read.entity.base.PageList;
import com.nnmedia.read.rxhttp.OnError;
import com.nnmedia.read.ui.adapters.MoreBooksAdapter;
...
public class MoreBooksListActivity extends BaseActivity implements OnItemClickListener, OnLoadMoreListener, OnRefreshListener {
    ...
    public static void start(Context context, String title, String columnId, int is_vip) {
        Intent starter = new Intent(context, MoreBooksListActivity.class);
        starter.putExtra("title", title);
        starter.putExtra("column_id", columnId);
        starter.putExtra("is_vip", is_vip);
