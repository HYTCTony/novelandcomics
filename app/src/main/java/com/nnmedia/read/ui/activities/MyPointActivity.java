...
import com.nnmedia.read.ui.adapters.PointDetailAdapter;
...
public class MyPointActivity extends BaseActivity implements View.OnClickListener {
    ...
    public int bindLayout() {
        return R.layout.activity_my_point_coin;
    }
    ...
    public void initView(View view) {
        ...
        initToolBar(toolbar, R.string.txt_point_balance);
        ...
        mAdapter = new PointDetailAdapter();
        recyclerView.setAdapter(mAdapter);
        mAdapter.setEmptyView(R.layout.layout_empty);

        View headView = LayoutInflater.from(this).inflate(R.layout.layout_rv_head_point_details, recyclerView, false);
    ...
    public void doBusiness(Context mContext) {
        ...
        tvAccumulatedGold.setText((getString(R.string.txt_accumulated_point) + "-"));
        tvGetGoldToday.setText((getString(R.string.txt_get_point_today) + "-"));
...
//                    startActivity(new Intent(this, WithdrawalActivity.class));
                    GoldExchangeVipActivity.start(this, 3);
                }
                break;
            default:
                break;
    ...
    public void reqMyCapitalDetail() {
        RxHttp.get(Consts.USER_CAPITAL_API)
                ...
                .subscribe(entity -> {
                    int goldCoinBalance = entity.getPoint();
...
//                    DecimalFormat df = new DecimalFormat("约" + "#######.##" + getString(R.string.unit_yuan));
                    ...
                    tvAccumulatedGold.setText((getString(R.string.txt_accumulated_point) + entity.getPoint_sum()));
                });
    }
    ...
    private void reqEarningsDetail(int page) {
        RxHttp.get(Consts.POINT_EARNINGS_LIST_API)
