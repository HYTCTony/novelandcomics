...
import com.nnmedia.read.ui.adapters.ReadingRecordsAdapter;
...
//        recyclerView.addItemDecoration(new SimpleDividerDecoration(this, R.dimen.dp_1, R.dimen.dp_16, R.color.col_gray_e5e5e5));
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.tv_asBtn_add_to_bookcase:
                ...
                if (UserInfoCache.getIsTourist(ReadingRecordActivity.this)) {
    ...
    private void goRegister(String content) {
        MessageDialog.show(ReadingRecordActivity.this, "提示", content, "去登录", "返回")
                .setCancelable(true)
