...
import com.nnmedia.read.ui.adapters.HPointAdapter;
 ...
 * 阅读点数明细
 */
public class MyHPointActivity extends BaseActivity implements View.OnClickListener{
    ...
    private HPointAdapter mAdapter;
    ...
    public int bindLayout() {
        return R.layout.activity_my_h_point;
    }
    ...
    public void initView(View view) {
        ...
        initToolBar(toolbar, R.string.txt_h_point_balance);
        ...
        TextView title = headView.findViewById(R.id.tv_title_normal);
        title.setText(getResources().getText(R.string.txt_h_point_details));
    ...
    public void doBusiness(Context mContext) {
        ...
        tvAccumulatedGold.setText((getString(R.string.txt_accumulated_gold_colon) + "-"));
        tvGetGoldToday.setText((getString(R.string.txt_get_gold_today_colon) + "-"));
...
//                    startActivity(new Intent(this, WithdrawalActivity.class));
    ...
    public void reqMyCapitalDetail() {
        RxHttp.get(Consts.USER_CAPITAL_API)
                ...
                .subscribe(entity -> {
                    int hPointBalance = entity.getH_point();
                    tvGoldBalance.setText(String.valueOf(hPointBalance));

                    int exchangeMoney;       //金币余额转换RMB
                    try {
                        exchangeMoney = hPointBalance / entity.getProportion();
                    } catch (Exception e) {
                        exchangeMoney = 0;
                    }
//                    DecimalFormat df = new DecimalFormat("约" + "#######.##" + getString(R.string.unit_yuan));
    ...
    private void reqEarningsDetail(int page) {
        RxHttp.get(Consts.H_POINT_EARNINGS_LIST_API)
