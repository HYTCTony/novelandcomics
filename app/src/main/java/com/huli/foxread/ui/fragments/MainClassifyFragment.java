...
public class MainClassifyFragment extends BaseFragment implements OnItemClickListener {
    ...
    public void setStatusBar(View view) {
        StatusBarUtils.offsetView(mActivity, $(view, R.id.tv_classify_title));
        StatusBarUtils.setAndroidNativeLightStatusBar(mActivity, true);
    }

    @Override
    public void initView(View view) {
        btnSearch = $(view, R.id.iv_asBtn_search);
        tabLayout = $(view, R.id.verticaltablayout_classify);
        recyclerView = $(view, R.id.recyclerView_content_classify);
        recyclerView.setLayoutManager(new LinearLayoutManager(mActivity));
        mAdapter = new SectionClassifyAdapter();
        recyclerView.setAdapter(mAdapter);

        textSelectCol = ContextCompat.getColor(mActivity, R.color.txt_red);
        textUnSelectCol = ContextCompat.getColor(mActivity, R.color.txt_black);
    }
