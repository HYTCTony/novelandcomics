...
//            activity.getWindow().addFlags(WindowManager.LayoutParams.FLAG_TRANSLUCENT_NAVIGATION);
    ...
    public static void setTranslucentForImageView(Activity activity, @IntRange(from = 0, to = 255) int statusBarAlpha,
        ...
        setTransparentForWindow(activity);
        addTranslucentView(activity, statusBarAlpha);
        offsetView(activity, needOffsetView);
    }
     ...
     * @param activity
     * @param dark
     * @param defaultColorId 无法修改文字颜色的时候设置的状态栏默认颜色
     */
    public static void setStatusBarTextDark(Activity activity, boolean dark, @ColorRes int defaultColorId) {
        ...
        if (type == RomUtils.AvailableRomType.ANDROID_NATIVE) {
            ...
            setColor(activity, ContextCompat.getColor(activity, defaultColorId), 0);
        }
    }
    ...
    public static void setStatusBarTextDark(Activity activity, boolean dark) {
        setStatusBarTextDark(activity, dark, R.color.colorPrimary);
    }
