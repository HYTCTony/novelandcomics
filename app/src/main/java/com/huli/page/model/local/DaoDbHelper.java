...
import com.huli.page.model.dao.DaoMaster;
import com.huli.page.model.dao.DaoSession;


public class DaoDbHelper {
    private static final String DB_NAME = "Read_DB";
    ...
    private DaoDbHelper() {
        //封装数据库的创建、更新、删除
        DaoMaster.DevOpenHelper openHelper = new MyOpenHelper(FrApp.getInstance(), DB_NAME, null);
        //获取数据库
