...
public class Constant {
    ...
    //FontDownloadPath
    public static String FONT_DOWNLOAD_PATH = FileUtils.getFilesPath() + File.separator
    ...
    public static final String NETWORK_ERROR_STRING = "访问失败，请检查网络连接！";
    public static final String SERVER_ERROR_STRING = "数据错误，请联系管理员！ ";
